      ...
      <Container fluid className="m-0 p-0 aboutMe">
        <Row className="m-0 p-0">
          ...
          <Col sm={6} className="d-flex justify-content-center p-0">
            <Image src="/service2.webp" alt="" width={2400} height={1598} />
          </Col>
          <Col sm={6} className="d-flex align-items-center">
            <div className="p-5  ">
              <h2 className="title3">¿Quiénes somos?</h2>
              <p className="parrafo">
                Una empresa que provee equipos, insumos y accesorios con
                excelentes estándares de calidad al sector médico. Nuestros
                fundadores, Josebely Bastidas y Johan Suarez formaron la empresa
                a través del compromiso y experiencia por más de dos décadas
                dedicadas al cuidado de la salud por varios países de
                Latinoamérica .
              </p>
            </div>
          </Col>
          <Col
            ...
            style={{ backgroundColor: "#4e0f59", color: "white" }}
          >
            <div className="p-5">
              <h2 className="title3 text-white">Misión</h2>
              <p className="parrafo">
                Garantizar el suministro de equipos, insumos y accesorios de las
                mejores marcas acompañado de un servicio técnico especializado
                confiable que supere con creces las expectativas de nuestros
                clientes.
              </p>
            </div>
          </Col>
          <Col sm={6} className="d-flex justify-content-center  p-0">
            <Image src="/service3.webp" alt="" width={2400} height={1598} />
          </Col>
          <Col sm={6} className="d-flex justify-content-center p-0">
            <Image src="/service9.webp" alt="" width={2400} height={1598} />
          </Col>
          <Col sm={6} className=" p-5 d-flex align-items-center">
            <div className="p-5">
              <h2 className="title3 ">Visión</h2>
              <p className="parrafo">
                Ser la empresa líder en el equipamiento de instrumentos para
                diagnóstico, insumos y accesorios médicos, reconocidos por su
                atención personalizada, servicio técnico, innovación, precios
                asequibles y productos de calidad.
              </p>
            </div>
          </Col>
