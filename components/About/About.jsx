      ...
      <Container fluid className="m-0 p-0 aboutMe">
        <Row  className="m-0 p-0">
          ...
          <Col sm={6} className="d-flex justify-content-center p-0">
            <Image  src="/service2.webp" alt=""   width={2400}
  height={1598}/>
          ...
          <Col sm={6} className="d-flex justify-content-center  p-0">
            <Image src="/service3.webp" alt=""   width={2400}
  height={1598} />
          </Col>
          <Col sm={6} className="d-flex justify-content-center p-0">
            <Image src="/service9.webp" alt=""  width={2400}
  height={1598} />
          </Col>
          ...
          <Col sm={6} className="d-flex justify-content-between  pt-4 px-0">
            <Image src="/team2.jpg" className="teamImg" alt=""  width={400} height={400} />
          ...
          <Col sm={6} className="d-flex justify-content-between pt-4 px-0">
            ...
            <Image src="/team3.jpg"  alt="" objectFit="cover" width={400} height={400} />
