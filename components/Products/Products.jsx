        ...
        <Col sm={12}>
          <Container fluid >
            ...
            <div className="searcher d-flex justify-content-center px-5">
              ...
              {
                arr1.map( (act, i) => 
                <div key={i} className="itemSearch d-flex align-items-center justify-content-start m-2 mb-0 mt-0 mx-4 cursor-pointer">
                  <Form.Check
                  ...
                  />
                  <label htmlFor={`inline-radio-${act.id}`}>
                    <Image
            ...
            <Row className="d-flex justify-content-around productItem">
              {
                arr.map( (act, i) =>   
                  <Col key={i} sm={3} className="mb-4 d-flex justify-content-center p-0 productItem">
